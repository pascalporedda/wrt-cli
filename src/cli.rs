...
Usage:
  wrt init [--force] [--print] [--accept-commands] [--model <codex-model>]  (default model: gpt-5.6-sol, reasoning medium)
...
Conventions:
  ...
  - Each worktree gets a reserved port allocation derived from the configured stride; block 0 is kept for the main workdir.
...
pub enum Cmd {
    ...
    Init {
        ...
        #[arg(long)]
        print: bool,
        /// Accept repository commands generated by Codex without an interactive prompt
        #[arg(long)]
    ...
    Clone {
        ...
        #[arg(long)]
        main: Option<String>,
        #[arg(long, value_enum, default_value_t = AutomaticBool::Auto)]
        install: AutomaticBool,
    ...
    /// Run a repository-owned runtime command for a worktree
    Runtime {
        /// Worktree name (optional if run from inside a worktree directory)
        #[arg(value_name = "NAME")]
        name: Option<String>,
        /// Explicit worktree name when it conflicts with an action
        #[arg(long, value_name = "NAME")]
        worktree: Option<String>,
        #[command(subcommand)]
...
pub enum RuntimeAction {
    ...
    Stop,
    /// Check the project runtime status
    Status,
}
